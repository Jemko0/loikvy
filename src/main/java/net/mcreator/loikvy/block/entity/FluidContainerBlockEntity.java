...
public class FluidContainerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public FluidContainerBlockEntity(BlockPos position, BlockState state) {
		super(LoikvyModBlockEntities.FLUID_CONTAINER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("fluid_container");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Fluid Container");
	}
