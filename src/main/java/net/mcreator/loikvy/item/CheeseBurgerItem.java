...
public class CheeseBurgerItem extends Item {
	public CheeseBurgerItem() {
		super(new Item.Properties().stacksTo(1).food((new FoodProperties.Builder()).nutrition(9).saturationModifier(2f).build()));
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.loikvy.cheese_burger.description_0"));
	}
